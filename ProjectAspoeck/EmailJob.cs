...
public class EmailJob : ServiceCollection
{
    ...
    private void TimerCallback(object? state)
    {
        ...
        if (IsWeekend(weekendCheck) == false)
        {
            ...
            string body = "";
            string end = "";
            var minutesBefore15 = new DateTime(now.Year, now.Month, now.Day, 7, 45, 0);
            ...
            if (now == new DateTime(now.Year, now.Month, now.Day, 7, 30, 0))
            {
